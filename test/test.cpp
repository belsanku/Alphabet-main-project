...
void assistant(int &check) {
  ...
  cout << "-A -- case-sensitive text sorting. Uppercase letters are changed to "
          "lowercase."
       << endl;
  ...
  cout << "Parameters can be written in any order, example: -d -A -r, -r -A, "
          "-A -d;"
       << endl;
  cout << "|| If none of the parameters is specified, then normal sorting will "
          "occur ||"
       << endl;
  cout << "If you are working with a .txt file containing Russian letters, you "
  ...
  cout << "After you have specified the parameter, write what the program "
       ...
       << endl;
  cout
      << "Example: -d -A string - work with string. -d -A file - work with file"
      << endl;
  check = 1;
}
//////////////////////////////////////////////////////////////////////////////////////////////////
...
TEST(SORTING, dedubl_sort_tester) {
  vector<string> sentence = {"my",    "name", "is", "slim",
                             "shady", "name", "is", "my"};
